...
const fill = ({ isSelected, selectedColor, hoverColor, color }: Props, hover: boolean): string => {
  if (isSelected)
...
const visibility = ({ isSelected, isSelectable, parentHover }: Props): CSS.Property.Visibility => {
  if (isSelected ||
    (isSelectable && parentHover))
    return 'visible';
  return 'hidden';
}
